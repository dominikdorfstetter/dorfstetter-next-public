...
import {AttachmentData, AttachmentsAttributes} from "@app/[lng]/blog/[id]/index";
 ...
 */
async function AttachmentsList({lng, attachments}: Readonly<{
    lng: string;
