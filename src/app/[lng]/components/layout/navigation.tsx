...
const Navigation = ({
  ...
  return (
    <nav className={styles.navMenu}>
      <Link
        href={`mailto:dominik@dorfstetter.at?subject=${lang.mailtoSubject}`}
      ...
      <Link
        href={`/${lng}`}
        title={`dorfstetter.at`}
        className={getClassName(styles.box, styles.mid_nav)}
        tabIndex={0}
      >
        <Image
      ...
      <div
        className={getClassName(styles.navIcon, styles.right_nav)}
        onClick={toggle}
