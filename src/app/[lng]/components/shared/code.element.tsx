 ...
 */
function CodeElement({code, elementId, translation}: Readonly<CodeElementProps>): React.JSX.Element {
    const updateElementStyle = (content: string) => {
        document.styleSheets[0].insertRule(`#${elementId}::after {content: '${content}';}`, 0);
    }
    ...
    return <div onClick={copyFunction} onKeyDown={copyFunction}>
