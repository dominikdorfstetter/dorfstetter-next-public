...
export const config: NextConfig = {
    matcher: ['/((?!api|_next/static|_next/image|assets|favicon|img|icons|fonts|sw.js|robots.txt|sitemap.xml).*)']
}
...
export function middleware(req: NextRequest): NextResponse {
    ...
    const isUnsupported = !languages.some(loc => topLevelPath === `${loc}`) &&
